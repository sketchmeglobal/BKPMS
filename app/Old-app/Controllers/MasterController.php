...
class MasterController extends BaseController
{
    ...
    // common
        ...
        if($master_tbl == 'employee'){
            ...
            $crud->setRelation('wh_id', 'master_warehouse', '{wh_name} - {wh_location}');
            $crud->setRelation('ol_id', 'master_outlet', '{ol_name} - {ol_location}');
            $crud->setRelation('state_id', 'master_state', '{state_name} - {state_code}');
            $crud->setRelation('city_id', 'master_city', '{city_name} - {city_code}');
        ...
        if($master_tbl == 'ticket-category'){
            $crud->setRelation('topic_id', 'master_ticket_topic', 'topic_name');
            $crud->setRelation('ticket_severity_id', 'master_severity', 'ticket_severity_name');
        }

        if($master_tbl == 'ticket-solution'){
            $crud->setRelation('ticket_category_id', 'master_ticket_category', 'ticket_category_name');
        }
