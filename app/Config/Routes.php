...
$routes->group('portal', static function ($routes) {
    ...
    $routes->group('inventory', static function ($routes) {
        ...
        $routes->match(['get', 'post'], 'stock-management', 'InventoryController::sm_list');
        $routes->match(['get', 'post'], 'ajax-edit-sm-fetch', 'InventoryController::ajax_edit_sm_fetch');

        $routes->match(['get', 'post'], 'inventory-issue', 'InventoryController::inventory_issue');
        $routes->match(['get', 'post'], 'inventory-issue/(:any)', 'InventoryController::inventory_issue');
        $routes->match(['get', 'post'], 'inventory-issue/(:any)/(:any)', 'InventoryController::inventory_issue');

        $routes->match(['get', 'post'], 'inventory-replacement', 'InventoryController::inventory_replacement');
        $routes->match(['get', 'post'], 'inventory-replacement/(:any)', 'InventoryController::inventory_replacement');
        $routes->match(['get', 'post'], 'inventory-replacement/(:any)/(:any)', 'InventoryController::inventory_replacement');

        $routes->post('ajax-remove-sm-list', 'InventoryController::ajax_remove_sm_list');
